...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pageview.status'
        db.add_column(u'tracking_pageview', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pageview.status'
        db.delete_column(u'tracking_pageview', 'status')
    ...
    models = {
        ...
        u'tracking.pageview': {
            ...
            'query_string': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
