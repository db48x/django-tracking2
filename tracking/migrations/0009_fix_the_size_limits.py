...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pageview.query_string'
        db.alter_column(u'tracking_pageview', 'query_string', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Pageview.query_string'
        db.alter_column(u'tracking_pageview', 'query_string', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
